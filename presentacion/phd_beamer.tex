...
% \includegraphics[width=0.2\textwidth]{figs/stacking.png}
...
{\includegraphics[width=0.8\textwidth]{figs/inversion.pdf}};
\draw [] (5.20, 2.05) node [right] {$x$};
\draw [] (2.55, 4.75) node [right] {$y$};
\draw [] (0.50, 1.00) node [right] {$z$};
\draw [] (4.30, 4.70) node [right] {$p(a,b,c)$};
\draw [](-0.50,-0.40) node [right] {$p(-a,-b,-c)$};
\draw [](-0.70, 3.20) node [right] {\rmfamily inversion point};
\draw [line width=1.3pt,->](1.50, 2.95) -- (2.60, 2.25) node [right] {};
\node[anchor=south west,inner sep=0] at (3.5,-0.3) 
{\includegraphics[width=0.3\textwidth,angle=180]{figs/inversion.pdf}};
...
\node[anchor=south west,inner sep=0] at (2.2, 1.3) 
...
\node[anchor=south west,inner sep=0] at (0.2,-0.3) 
{\includegraphics[width=0.9\textwidth]{figs/up3.png}};
\node[anchor=south west,inner sep=0] at (1.7, 0.0) 
{\includegraphics[width=0.6\textwidth]{figs/helix2.pdf}};
...
\node[anchor=south west,inner sep=0,opacity=0.50] at (0.2,-0.3) 
{\includegraphics[width=0.60\textwidth]{figs/up4.png}};

\node[anchor=south west,inner sep=0] at (0.75,-0.15) 
{\includegraphics[width=0.33\textwidth]{figs/coord18.pdf}};

\node[] at (4.50, 1.5) {$\mathcal{D}^{z}$ = 55\%};
...
\node[anchor=south west,inner sep=0,opacity=0.50] at (0.2,-0.3) 
{\includegraphics[width=0.60\textwidth]{figs/alt4.png}};

\node[anchor=south west,inner sep=0] at (0.60,-0.15) 
{\includegraphics[width=0.25\textwidth]{figs/coord17.pdf}};

\node[] at (4.50, 1.5) {$\mathcal{D}^{x}$ = 38\%};
\node[] at (4.50, 1.1) {$\mathcal{D}^{y}$ = 40\%};
...
Components with maximum values of $\mathcal{V}^{\mathrm{ab}}$ for the
\emph{alt}, \emph{up}, CdSe and GaAs structures (Eq. \ref{eq:psc}).
...
\node[anchor=south west,inner sep=0,opacity=0.40] at (0.2,-0.3) 
{\includegraphics[width=0.80\textwidth]{figs/up4.png}};
...
\vspace{-1mm}
\item 
The absolute maxima is 645\,Km/s for $\alpha = 150^{\circ}$
...
\node[anchor=south west,inner sep=0,opacity=0.40] at (0.2,-0.3) 
{\includegraphics[width=0.75\textwidth]{figs/alt4.png}};
...
\item The absolute $y$ maxima is at $\hbar\omega = 0.719$\,eV:
$\mathcal{V}_{\mathrm{y}} = 906$\,Km/s at 
$\theta_{\mathrm{y}} = 120^{\circ}$ and
$\varphi_{\mathrm{y}} = 163^{\circ}$
