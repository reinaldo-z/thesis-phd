...
set xlabel "{\\huge Photon Energy (eV)}"
...
set ylabel "{\\huge $\\eta^{yxy}(\\omega)$ [mC$^{3}$/J$^{2}$s$^{2}$]}"
set key bottom right
set output "eta-alt_y.mp"
p   "data/alt/res-nospin_0-2eV/calEta2.kk_xxy_yxy_zxy_14452_1_65-nospin_scissor_0_Nc_41" u 1:(-$3*lm) title "\\Large H-top"     w l ls 2 lw 1.5,\
    "data/alt/res-nospin_0-2eV/calEta2.kk_xxy_yxy_zxy_14452_2_65-nospin_scissor_0_Nc_41" u 1:(-$3*lm) title "\\Large C"         w l ls 3 lw 1.5,\
    "data/alt/res-nospin_0-2eV/calEta2.kk_xxy_yxy_zxy_14452_3_65-nospin_scissor_0_Nc_41" u 1:(-$3*lm) title "\\Large H-bottom"  w l ls 5 lw 1.5,\
    "data/alt/res-nospin_0-2eV/eta2.kk_xxy_yxy_zxy_14452_65-nospin_scissor_0_Nc_41"      u 1:($3*lm)  title "\\Large Total"     w l ls 1 lw 2,\
